...
if [ ! -f "$CROSS_SECTION_FILE_DIR/cross_sections.xml" ]; then
        ...
        echo "Download this file from https://anl.box.com/shared/static/9igk353zpy8fn9ttvtrqgzvw1vtejoz6.xz and extract tar -xvf //anl.box.com/shared/static/9igk353zpy8fn9ttvtrqgzvw1vtejoz6.xz into a host directory and map it into the container directory $CROSS_SECTION_FILE_DIR
...
mpirun --report-bindings --map-by core --bind-to core -np 64 openmc -s 4 /docker/run/DATA
